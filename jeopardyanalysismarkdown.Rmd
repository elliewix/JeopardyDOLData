...
```{r echo = F}
 winningagg <- aggregate(justwinnings$cleanplayersnoNA.winnings, list( main = justwinnings$cleanplayersnoNA.main), mean)
...
boxplot(morethanone$winnings ~ morethanone$main, data = morethanone)
